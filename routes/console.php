...
Schedule::command('orders:cancel-abandoned')->everyFiveMinutes()->withoutOverlapping();
Schedule::command('support:sweep-tickets')->everyFifteenMinutes()->withoutOverlapping()->onOneServer();
