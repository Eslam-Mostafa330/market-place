...
class NotificationController extends BaseApiController
{
    ...
    /**
     * Mark a single notification as read that related to the authenticated vendor.
     */
    ...
    /**
     * Mark all notifications as read that related to the authenticated vendor.
     */
    ...
    /**
    * Get the count of unread notifications that related to the authenticated vendor.
    */
