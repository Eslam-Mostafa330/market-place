...
use App\Http\Resources\Support\Ticket\TicketAssignmentResource;
use App\Http\Resources\Support\Ticket\TicketResource;
use App\Http\Resources\Support\Ticket\TicketStatusResource;
...
class TicketController extends BaseApiController
{
    ...
    public function index(): AnonymousResourceCollection
    {
        ...
        $tickets = SupportTicket::with('requester:id,name,email', 'agent:id,name')
    ...
    public function claim(SupportTicket $ticket): JsonResponse
    {
        ...
        return $this->apiResponseUpdated(new TicketAssignmentResource($ticket->load('agent:id,name')));
    }
    ...
    public function updateStatus(UpdateTicketStatusRequest $request, SupportTicket $ticket): JsonResponse
    {
        ...
        return $this->apiResponseUpdated(new TicketStatusResource($ticket));
    }
}
