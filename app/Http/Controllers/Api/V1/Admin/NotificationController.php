...
class NotificationController extends BaseApiController
{
    ...
    /**
     * Mark a single notification as read that related to the authenticated admin.
     */
    ...
    /**
     * Mark all notifications as read that related to the authenticated admin.
     */
    ...
    /**
    * Get the count of unread notifications that related to the authenticated admin.
    */
