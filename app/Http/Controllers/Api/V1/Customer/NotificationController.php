...
class NotificationController extends BaseApiController
{
    ...
    /**
     * Mark a single notification as read that related to the authenticated customer.
     */
    ...
    /**
     * Mark all notifications as read that related to the authenticated customer.
     */
    ...
    /**
    * Get the count of unread notifications that related to the authenticated customer.
    */
