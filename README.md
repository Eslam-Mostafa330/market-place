Multi-Vendor Food Delivery REST API

A Laravel-based RESTful API that simulates an on-demand multi-vendor delivery marketplace.
The system models customers, vendors, stores, and riders interacting through a complete order lifecycle.
...
Authentication is handled via token-based access control.
